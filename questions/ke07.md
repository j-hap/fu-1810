...
### Was ist *algrbraische Optimierung*?
...
### Unter welchen Bedingungen werden zwei Knoten im Flussgraphen miteinander verbunden?
...
- Sprachen, die eine mathematische Struktur haben, was eigentlich nur auf Funktionale Sprachen zutrifft
- Relationenalgebra in Datenbankabfragesprachen

### Was ist ein Hauptanwendungfall von algebraischer Optimierung?
...
### Welche 5 lokalen Optimierungen werden im Kurstext beschreiben?
...
eine lokale (algebraische) Optimierungstechnik, bei der komplexe Operationen durch einfachere ersetzt werden können
(ggf. abhängig vom Befehlssatz der Maschine)
...
### Welche 2 globalen Optimierungen werden im Kurstext beschreiben?
