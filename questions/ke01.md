...
- Portabilität
- dynamische Sprachkonstrukte (z.B. zur Laufzeit modifizierte Objekte)
...
die Eigenschaft eines Lexers bei zwei konfliktierenden Regen das Token mit dem längsten Präfix
auszugeben
